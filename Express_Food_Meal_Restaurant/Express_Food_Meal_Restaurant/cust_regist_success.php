...
<head>
    ...
    <title>Successfully Registered | Express Food Meal Restaurant</title>
</head>
...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="img/Logo-02.png" width="150" class="me-2" alt="Logo">
            </a>
        </div>
    </header>
    <div class="mt-5"></div>
    <div class="container form-signin text-center reg-success mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold">Welcome and enjoy your food with Pizza World</p>
